...
- [#395](https://github.com/LewisIsWorking/Tongs-Browser/pull/395) [`ed8fd53`](https://github.com/LewisIsWorking/Tongs-Browser/commit/ed8fd53eb9ac8d5776aa7792711050f45ac641f2) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Answer ComeOnOverUno world-swap requests from the GM's browser.
...
- [#393](https://github.com/LewisIsWorking/Tongs-Browser/pull/393) [`aefa7a9`](https://github.com/LewisIsWorking/Tongs-Browser/commit/aefa7a96def8491e4f682213d00a700dfcec38b5) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Aimed and sneaking hits are applied automatically again. A hit was checked by rolling the strike a second time and demanding the same formula, which cannot work for damage that depends on the target: an operative's Aim die and Sneak Attack's precision die are worked out from the fight as it was when the player rolled. Tongs now checks that every die on the card is one PF2e named, alongside the paired hit, the once-only rule and a total inside the roll's own range.
...
- [#383](https://github.com/LewisIsWorking/Tongs-Browser/pull/383) [`4a1860f`](https://github.com/LewisIsWorking/Tongs-Browser/commit/4a1860ff5a03317f42e61ed6bccdfb7f0da81f3c) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Encounter sync: with the new "Sync encounters to the combat topic" setting on, the GM's browser keeps one tracker message per Foundry encounter in the campaign's Telegram combat topic, through ComeOnOverUno: the round, the allies still to act with their players named and those who have acted struck off, then the enemies. Hidden and defeated combatants are left out and enemies are named as players may see them. A new "Telegram players" menu links each Foundry player to their Path Wars Telegram player. The Path Wars bot reads the encounter from ComeOnOverUno to ping.
...
- [#379](https://github.com/LewisIsWorking/Tongs-Browser/pull/379) [`27d17f6`](https://github.com/LewisIsWorking/Tongs-Browser/commit/27d17f6c523800e8a5ad49ed2f057b4f96d2d23d) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Automatic strike damage, spell saves and spell damage now reach creatures on any scene. The GM no longer has to open the map a fight is on: the roll deck aims PF2e's own apply and save controls at the target's token document for one click, instead of borrowing the GM's canvas selection, so a hit on another scene lands straight away. The strike formula check also never falls back to whatever the GM happens to have targeted.
...
- [#371](https://github.com/LewisIsWorking/Tongs-Browser/pull/371) [`6bf0f06`](https://github.com/LewisIsWorking/Tongs-Browser/commit/6bf0f06b6c3846ba0d592f3269c3000d6418b90f) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Health bands now follow each party's campaign, so one world can host several Path Wars campaigns.

  The world-wide **Path Wars campaign for health bands** setting is gone. Instead, **Party campaigns** in the
  module settings gives each party its own campaign code, such as C06. When an enemy is hurt, its band goes
  to the campaign of the player characters fighting in that combat.

  - A combat with no coded party, or with characters from two different campaigns, posts nothing, and the
    GM is told why once, so a band never lands in another table's topic.
  - A value that is not a campaign code (a C and digits) is refused rather than saved.
...
- [#365](https://github.com/LewisIsWorking/Tongs-Browser/pull/365) [`aa015ff`](https://github.com/LewisIsWorking/Tongs-Browser/commit/aa015ffe915c36ccdab928443a3dc01296de6625) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Optionally apply players' basic-save spell damage to enemies by each one's degree of success.
...
- [#363](https://github.com/LewisIsWorking/Tongs-Browser/pull/363) [`9f12746`](https://github.com/LewisIsWorking/Tongs-Browser/commit/9f12746126ad988a8aa285a7ba917ed45ded21ab) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Optionally roll enemies' saving throws against players' spells without waiting for the GM.
...
- [#361](https://github.com/LewisIsWorking/Tongs-Browser/pull/361) [`930ec21`](https://github.com/LewisIsWorking/Tongs-Browser/commit/930ec21039b4ea14d16821a3198ca1db0348bfbb) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Optionally apply players' checked strike damage to enemies without waiting for the GM.
...
- [#356](https://github.com/LewisIsWorking/Tongs-Browser/pull/356) [`3faed58`](https://github.com/LewisIsWorking/Tongs-Browser/commit/3faed58d8d4d0d27ba50ed3cd9af080d505ddb28) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Add the GM roll deck: apply damage and roll saves from chat with large buttons, one card at a time.
...
- [#355](https://github.com/LewisIsWorking/Tongs-Browser/pull/355) [`f6ec289`](https://github.com/LewisIsWorking/Tongs-Browser/commit/f6ec2891e324332f7cbf3f760af53e732c4da216) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Bring the first-install checklist up to date for 0.28.0.
...
- [#354](https://github.com/LewisIsWorking/Tongs-Browser/pull/354) [`c7b405d`](https://github.com/LewisIsWorking/Tongs-Browser/commit/c7b405d7c820c03de1b27d1bdc7d52cad5e99eb4) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Declare Foundry 14.367 as the verified build.
...
- [#328](https://github.com/LewisIsWorking/Tongs-Browser/pull/328) [`b5fa611`](https://github.com/LewisIsWorking/Tongs-Browser/commit/b5fa6116bd0a6c927b60428af6a55d82fdc08022) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Add the write half of the party flag, so a GM can actually open a party to players.
...
- [#326](https://github.com/LewisIsWorking/Tongs-Browser/pull/326) [`f95a067`](https://github.com/LewisIsWorking/Tongs-Browser/commit/f95a06700df2554af2a016e59d6ef78c785a9a11) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Put the create-sheet button on the tray and wire it to Foundry. Slice 3 of the feature is complete.
...
- [#322](https://github.com/LewisIsWorking/Tongs-Browser/pull/322) [`8cf149d`](https://github.com/LewisIsWorking/Tongs-Browser/commit/8cf149d244cd0fbaed964068ed94991c879ef904) Thanks [@LewisIsWorking](https://github.com/LewisIsWorking)! - Add the picker the create button will put on screen, and a notice for when there is nothing to pick.

  It closes itself before running the callback rather than leaving that to the caller. [#304](https://github.com/LewisIsWorking/Tongs-Browser/issues/304) showed why:
