...
| `deckSwipe.ts`       | Swiping between cards: a pure reading of the swipe, and its passive listeners |
...
- **Swipe as well as buttons.** Left for the next card, right for the previous. The buttons stay, because a
  gesture that half works cannot tell you what you did wrong.
